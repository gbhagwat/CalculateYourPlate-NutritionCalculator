 <template>
  <div>
    <div class="btn-group my-4">
      <button type="button" class="btn btn-primary mr-1" @click="saladsShow">Salads</button>
      <button type="button" class="btn btn-primary mr-1" @click="flatbreadsShow">Flatbreads</button>
      <button type="button" class="btn btn-primary" @click="showAll">All</button>
    </div>
    <div v-if="showSalads">
      <h3>Salads</h3>
      <div class="p-3 mb-3">
